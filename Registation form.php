      ...
      <div class="col-sm-6 ">
        ...
        <!--<div class="form-group">
          ...
          <div class="row">
            ...
            <input type="SUBMIT" value="Submit" name="save"class="btn btn-success btn-group-justified" required style="color:#000;font-family: 'Baloo Bhai', cursive;height:40px;margin-left:280px;">
          </div>
          </div>
          </div>
        </form>
